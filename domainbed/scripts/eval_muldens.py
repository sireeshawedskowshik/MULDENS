...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', type=str, default="MULDENS_without_aug/TerraIncognita_M3_seed0/env1/indiv_ensemble_no_beta")
    ...
    for i in range(len(ckpt_names)):
        ...
        if args.algorithm == 'MULDENS': 
            ...
            results_MULDENS = misc.MULDENS_accuracy(algorithm, eval_dict, args.test_envs, correct_models_selected_for_each_domain,device,acc_flags)
            ...
            misc.print_row([results_MULDENS[key] for key in results_keys],colwidth=25)
