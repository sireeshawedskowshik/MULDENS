...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', type=str, default="Invenio_without_aug/TerraIncognita_M3_seed0/env1/indiv_ensemble_no_beta")
    ...
    for i in range(len(ckpt_names)):
        ...
        if args.algorithm == 'INVENIO': 
            ...
            misc.print_row([results_invenio[key] for key in results_keys],colwidth=25)
